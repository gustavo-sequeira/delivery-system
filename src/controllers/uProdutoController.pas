...
begin
  ...
  try
    FDQuery.Connection := FConnection;
    FDQuery.SQL.Text := 'EXECUTE PROCEDURE SP_ALTERAR_PRODUTO(:P_ID, :P_NOME, :P_DESCRICAO , :P_PRECO , :P_ESTOQUE , :P_CATEGORIA , :P_SUBCATEGORIA , :P_CODIGO , :P_DATA_VALIDADE , :P_OBSERVACAO )';
